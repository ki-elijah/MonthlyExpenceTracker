...
def values():
    ...
    if answer == 1:
        ...
        while True:
            ...
            period = str(input(
                "Enter 1 to change period \nEnter 2 to go back \nEnter 3 to Quit \nEnter any key to keep going \n: --> "))
            if period == "1":
                date = str(
                    input('Enter Date (YYYY,MM,DD) (optional) \n: --> '))
                try:
                    year,month,day = map(int,date.split(','))
                    print(day)
                    date = datetime.date(year, month,day)
        ...
        while True:
            expense = int(
                input("Enter your expense for today if any \n: --> "))
            particular = str(input("Enter Description (Optional) \n: --> "))
...
while True:
    ...
    if message == 1:
        ...
        try:
            ...
            print(
                "No Data to Plot. Make sure that you have entered Income-Expense Details.")
    elif message == 3:
        try:
            ...
            print(
                'No Data to Show. Make sure that you have entered Income-Expense Details')
    else:
        break
